// File: app/electron/ipc.ts

/**
 * Typdefinitionen für IPC-Kommunikation zwischen Main und Renderer Process
 */
...
/**
 * Interface für das globale window.promptVault API
 */
export interface PromptVaultAPI {
  // Existing App APIs
